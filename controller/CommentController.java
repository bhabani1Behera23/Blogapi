...
public class CommentController {
    ...
    public ResponseEntity<CommentDto>geteCommentById(@PathVariable(value = "postId") long postId,@PathVariable(value = "id")long id){
        CommentDto dto=commentService.geteCommentById(postId,id);
